...
By default, Kedro follows a Data Engineering Convention to classify datasets and managing data. From *raw*, our initials datasets  to *model input* cleaned datasets with missing values treated and ready to be used in our models.
...
## Define raw files in Kedro Data catalog
